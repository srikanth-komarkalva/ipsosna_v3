...
#     drill_fields: [age_quota,c_favorite,country10,emp01,wave_new,wtct,percent_weight]
  ...
  set: detail {
    fields: [age_quota,quota_ethnicity,emp01,wtct,ytcvariable_eav.unwtct]
  }
  ...
  measure: sum_wtct_subtotal {
    ...
    sql:  sum(${wtct}) OVER ( PARTITION BY
          ...
          -- all category map fields
              ...
              {% if ytccategory_map_2.string_field_3._is_selected %} ${ytccategory_map_2.string_field_3} , {% endif %}
